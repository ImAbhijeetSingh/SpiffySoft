...
$(function () {
    ...
    ***************************/
    ...
    function initMilUpAnimations() {
        // Kill previous .mil-up triggers to avoid duplicates (Swup reinit)
        milUpTriggers.forEach((t) => t.kill());
        milUpTriggers = [];

        const appearance = gsap.utils.toArray(".mil-up");
        ...
        appearance.forEach((section) => {
            ...
            if (tween.scrollTrigger) {
                milUpTriggers.push(tween.scrollTrigger);
            }
        });
    }
    /***************************
...
// document.getElementById("copyright-year").innerHTML = "2024";
